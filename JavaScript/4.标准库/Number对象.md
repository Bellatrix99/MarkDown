## 1. 概述 [#](https://wangdoc.com/javascript/stdlib/number.html#概述)
...
`toString`方法只能将十进制的数，转为其他进制的字符串。如果要将其他进制的数，转回十进制，需要使用[`parseInt`](https://www.w3school.com.cn/js/jsref_parseInt.asp)方法。
